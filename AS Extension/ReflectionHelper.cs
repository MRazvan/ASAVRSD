...
namespace SoftwareDebuggerExtension
{
    public static class ReflectionHelper
    {
        ...
        {
            var fields =
                typeof(T).GetFields(BindingFlags.Instance | BindingFlags.Static | BindingFlags.NonPublic |
                                    BindingFlags.Public | (declaredOnly ? BindingFlags.DeclaredOnly : 0));
        ...
        public static object GetFieldValue(object instance, string fieldName)
        {
            ...
            if (field == null)
                throw new ArgumentOutOfRangeException(
                    $"The field name {fieldName} was not found on type {instance.GetType()}");
        ...
        public static object GetPropertyValue(object instance, string propName)
        {
            ...
            if (prop == null)
                throw new ArgumentOutOfRangeException(
                    $"The field name {propName} was not found on type {instance.GetType()}");
