...
namespace ELFSharp.MachO
{
    public class SymbolTable : Command
    {
        ...
        public SymbolTable(BinaryReader reader, Func<FileStream> streamProvider, bool is64)
            : base(reader, streamProvider)
        {
            this.is64 = is64;
            ReadSymbols();
        }
        ...
        private void ReadSymbols()
        {
            ...
            try
            {
                for (var i = 0; i < numberOfSymbols; i++)
                {
                    ...
                    var value = is64 ? symbolReader.ReadInt64() : symbolReader.ReadInt32();
